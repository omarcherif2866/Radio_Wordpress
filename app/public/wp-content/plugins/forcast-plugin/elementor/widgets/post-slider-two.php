...
class Empath_Post_Slider_Two extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Slider Two', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
            'type',
            [
                'label'          => __( 'Video Type', 'gesto-core' ),
                'type'           => Controls_Manager::CHOOSE,
                'label_block'    => false,
                'options'        => [
                    'ex_url'  => [
                        'title' => __( 'External URL', 'gesto-core' ),
                        'icon'  => 'eicon-video-playlist',
                    ],
                    'self_upload' => [
                        'title' => __( 'Self Upload', 'gesto-core' ),
        ...
        $this->add_control(
			'add_video_url', [
				'label' => esc_html__( 'Video URL', 'gesto-plugin' ),
        ...
        $this->add_control(
			'upload_video', [
				'label' => esc_html__( 'Upload Video', 'gesto-plugin' ),
		...
		$this->add_control(
			'title2_length',
			[
				'label'     => __( 'Title Thumb Length', 'empath-plugin' ),
				'type'      => Controls_Manager::NUMBER,
				'step'      => 1,
				'default'   => 20,
			]
		...
		$this->start_controls_section(
			'--image-settings--',
			[
				'label' => esc_html__( 'Image Large Post Style', 'empath-plugin' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .slider-for .bytf__feature-image img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .slider-for .bytf__feature-image img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .slider-for .bytf__feature-image' => 'max-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .slider-for .bytf__feature-image' => 'flex:0 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .slider-for .bytf__feature-image' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		$this->start_controls_section(
			'--image-sm-settings--',
			[
				'label' => esc_html__( 'Image Small Post Style', 'empath-plugin' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .slider-nav .bytf__feature-image img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .slider-nav .bytf__feature-image img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .slider-nav .bytf__feature-image' => 'max-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .slider-nav .bytf__feature-image' => 'flex:0 0 {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .slider-nav .bytf__feature-image' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_group_control(
			...
			[
				'name' => 'box-border',
				'selector' => '{{WRAPPER}} .bytf__post-list-item-two',
			]
		);
		...
		$this->start_controls_section(
			'--titleth-settings--',
			[
				'label' => esc_html__( 'Title Thumb Style', 'empath-plugin' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .slider-nav .bytf_post_title-sm' => 'color: {{VALUE}}',
					'{{WRAPPER}} .post_slider_three__thumb .bytf_post_title' => 'color: {{VALUE}}'
				],
			]
		);
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'title_th_typography',
				'label' => esc_html__( 'Title Font', 'empath-plugin' ),
				'selector' => '
				{{WRAPPER}} .slider-nav .bytf_post_title-sm,
				{{WRAPPER}} .post_slider_three__thumb .bytf_post_title
				'
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .slider-nav .bytf__content h4' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .slider-nav .bytf_post_title-sm' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-slider-two/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Slider_Two() );