...
class Empath_Post_Carosule extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Carosul', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'--box-margin--',
			[
				'label' => esc_html__( 'Box Margin', 'empath-plugin' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__post-grid-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-carousel/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Carosule() );