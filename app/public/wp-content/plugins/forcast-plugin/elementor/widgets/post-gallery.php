...
class Empath_Post_Gallery extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Gallery', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_length_th',
			[
				'label'     => __( 'Thumbnail Title Length', 'empath-plugin' ),
				'type'      => Controls_Manager::NUMBER,
				'step'      => 1,
				'default'   => 20,
			]
		...
		$this->add_responsive_control(
			'--lg-roundimg-margin--',
			[
				'label' => esc_html__( 'Large Image Round', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__post-overlay-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Thumb Image Style', 'empath-plugin' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_responsive_control(
			'th_width',
			[
				'label' => esc_html__( 'Thumb Image Width', 'empath-plugin' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'range' => [
					'%' => [
				...
				'selectors' => [
					'{{WRAPPER}} .bytf__post__gallery-nav .bytf__feature-image img' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bytf__post__gallery-nav .bytf__feature-image img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bytf__post__gallery-nav .bytf__feature-image' => 'max-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .bytf__post__gallery-nav .bytf__feature-image' => 'flex:0 0 {{SIZE}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__post__gallery-nav .bytf__feature-image' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__post__gallery-nav .bytf__post-overlay-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
        ...
        $this->add_control(
			'title-th-color',
			[
				'label' => esc_html__( 'Thumbnail Title Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bytf__post__gallery-nav .bytf__content h4' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Thumbail Title Font', 'empath-plugin' ),
				'selector' => '{{WRAPPER}} .bytf__post__gallery-nav .bytf__content h4',
			]
		);
		$this->add_responsive_control(
			'--title-margin--',
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-gallery/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Gallery() );