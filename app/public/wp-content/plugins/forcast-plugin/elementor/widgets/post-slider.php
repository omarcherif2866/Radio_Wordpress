...
class Empath_Post_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Slider', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'__posts_th_info',
			[
				'label' => esc_html__( 'Posts Thumbnail Option', 'empath-plugin' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'style' => '1',
				],
		...
		$this->add_control(
			'overly-lg-color',
			[
				'label' => esc_html__( 'Overlay BG Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post__slider_item-wrapper:after' => 'background: {{VALUE}}',
				],
			]
		);
		$this->end_controls_section();
        ...
        $this->add_control(
			'title-lg-color',
			[
				'label' => esc_html__( 'Title Large Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post__slider_item-wrapper .post__slider-content .bytf_post_title' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .bytf__content h4',
			]
		);
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'title_lg_typography',
				'label' => esc_html__( 'Large Title Font', 'empath-plugin' ),
				'selector' => '{{WRAPPER}} .post__slider_item-wrapper .post__slider-content .bytf_post_title',
			]
		);
		$this->add_responsive_control(
			'--title-margin--',
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-slider/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Slider() );