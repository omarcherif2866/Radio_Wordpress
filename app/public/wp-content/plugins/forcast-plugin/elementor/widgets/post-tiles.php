...
class Empath_Post_Tiles extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Tiles', 'empath-plugin' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'title--color',
			[
				'label' => esc_html__( 'Title Post Color', 'empath-plugin' ),
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '
				{{WRAPPER}} .post_tile_large .bytf_post_title
				'
			]
		);
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Title List Post Font', 'empath-plugin' ),
				'selector' => '
				{{WRAPPER}} .post_tile_large-sm .bytf_post_title
				'
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			'--title-list-margin--',
			[
				'label' => esc_html__( 'Title List margin', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .post_tile_large-sm .bytf_post_title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-tiles/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Tiles() );