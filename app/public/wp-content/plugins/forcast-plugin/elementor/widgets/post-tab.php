...
class Empath_Post_Tab extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Tab', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'is_active',
			[
				'label'          => esc_html__( 'Active Tab Item', 'barfii-plugin' ),
				'type'           => Controls_Manager::SWITCHER,
				'label_on'       => esc_html__( 'YES', 'barfii-plugin' ),
				'label_off'      => esc_html__( 'NO', 'barfii-plugin' ),
				'return_value'   => 'yes',
				'default'        => 'no',
				'style_transfer' => true,
			]
		...
		$repeater->add_control(
			'tab_title', [
				'label'       => esc_html__( 'Title', 'barfii-plugin' ),
        ...
        $this->add_control(
			'post_tabs',
			[
				'label'       => __( 'Add Tab Item', 'barfii-plugin' ),
		...
		$this->start_controls_section(
			'--count-settings--',
			[
				'label' => esc_html__( 'Count Style', 'empath-plugin' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			'count--color',
			[
				'label' => esc_html__( 'Count Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .post_count' => 'color: {{VALUE}}'
				],
			]
		);
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'count__typography',
				'label' => esc_html__( 'Count Font', 'empath-plugin' ),
				'selector' => '
				{{WRAPPER}} .post_count
				'
			]
		...
		$this->add_responsive_control(
			'--count-margin--',
			[
				'label' => esc_html__( 'Count margin', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .post_count' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-tab/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Tab() );