...
class Empath_Post_Rating extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Rating', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'rating_hide',
			[
				'label'          => esc_html__( 'Rating HIDE/SHOW', 'empath-plugin' ),
				'type'           => Controls_Manager::SWITCHER,
				'label_on'       => esc_html__( 'Show', 'empath-plugin' ),
				'label_off'      => esc_html__( 'Hide', 'empath-plugin' ),
				'return_value'   => 'yes',
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ptx-header-main-menu-area .main-navigation li a' => 'color: {{VALUE}}',
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ptx-header-main-menu-area .main-navigation li:hover a, .ptx-header-section .dropdown:hover a:after' => 'color: {{VALUE}} !important',
					'{{WRAPPER}} .ptx-header-section .dropdown-menu a:hover' => 'color: {{VALUE}} !important'
				],
			]
		);
        $this->add_control(
			'menu-hover-bg',
			[
				'label' => esc_html__( 'Menu Hover BG Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ptx-header-section.type_four .main-navigation li a:before' => 'background: {{VALUE}} !important',
				],
				'condition' => [
					'style' => ['4'],
				],
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'menu_tct_typography',
				'selector' => '
					{{WRAPPER}} .ptx-header-main-menu-area .main-navigation li a,
		...
		$this->start_controls_section(
			'menu_livechat_style',
			[
				'label' => esc_html__( 'Live Chat Style', 'empath-plugin' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        $this->add_control(
        ...
        $this->add_group_control(
			...
			[
				'name' => 'live_top_bar_bg',
				'types' => [ 'gradient' ],
				'exclude' => [ 'image' ],
				'selector' => '
				{{WRAPPER}} .header-cta .inner-icon i
				',
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__( 'Gradient Icon BG', 'empath-plugin' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .header-cta .inner-text span' => 'background: {{VALUE}}; background-clip: text;
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'menu_live_typography',
				'selector' => '{{WRAPPER}} .header-cta .inner-text span',
			]
		);
		$this->add_control(
			'live-text--styl',
			[
				'label' => esc_html__( 'Live Text Style', 'empath-plugin' ),
				'type' => \Elementor\Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .header-cta .inner-text a' => 'color: {{VALUE}} ',
				],
			]
		);
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'menu_live_txt_typography',
				'selector' => '{{WRAPPER}} .header-cta .inner-text a',
			]
		);
		$this->end_controls_section();
		$this->start_controls_section(
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-rating/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Rating() );