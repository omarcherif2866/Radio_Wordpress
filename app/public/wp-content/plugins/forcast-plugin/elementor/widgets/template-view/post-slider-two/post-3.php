<div class="post__slider-main-area style__agn">
                    ...
                    <div class="post__slider_twq-main text-center" style="background-image: url(<?php echo get_the_post_thumbnail_url(get_the_ID(), 'full' );?>)">
                        <div class="container">
                            <div class="bytf__content">
                                ...
                                <div class="bytf__postmeta-info-wrapper-two justify-content-center">                    
                                        ...
                                        <div class="bytf__postmeta-two">
                                            <ul class="d-flex align-items-center">
                                                ...
                                                <?php if('yes' === $settings['date_hide']):?>
                                                    ...
                                                    <path d="M8.99984 14.8334C12.2215 14.8334 14.8332 12.2217 14.8332 9.00002C14.8332 5.77836 12.2215 3.16669 8.99984 3.16669C5.77818 3.16669 3.1665 5.77836 3.1665 9.00002C3.1665 12.2217 5.77818 14.8334 8.99984 14.8334Z" stroke="#BFBDBD" stroke-width="1.5"/>
                                                    <path d="M3.97078 1.61334C3.40545 1.76475 2.88995 2.06234 2.47611 2.47617C2.06227 2.89001 1.76469 3.40551 1.61328 3.97084M14.0291 1.61334C14.5944 1.76475 15.1099 2.06234 15.5238 2.47617C15.9376 2.89001 16.2352 3.40551 16.3866 3.97084M8.99995 5.66668V8.79168C8.99995 8.90668 9.09328 9.00001 9.20828 9.00001H11.4999" stroke="#BFBDBD" stroke-width="1.5" stroke-linecap="round"/>
                                                    </svg>
