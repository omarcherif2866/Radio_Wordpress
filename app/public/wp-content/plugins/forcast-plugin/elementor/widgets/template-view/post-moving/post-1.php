<div class="post-ov-sroller">
    ...
    ?>
        <div class="bytf__post-overlay-item style__five moving__post">
            ...
            <div class="bytf__content">
                ...
                <?php if('video' == get_post_format( $idd ) ):?>
                    <div class="bytf__video">
                        <a aria-label="name" class="bytf-video-popup" href="<?php echo esc_url($video_link);?>"><i class="fal fa-play"></i></a>
                    </div>
                <?php endif;?>
