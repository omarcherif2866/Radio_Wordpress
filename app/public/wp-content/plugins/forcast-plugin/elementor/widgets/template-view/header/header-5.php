...
?>
<header class="main-header main-header-five is-sticky">
             ...
             <div class="byteflows_right_header d-flex align-items-center">    
                ...
                <?php if(!empty($__rzlogo['url']) || !empty($_dark_rzlogo['url'])):?>
                    <div class="byteflows_logo">
                        ...
                        <a class="light-logo" href="<?php echo esc_url($custom_link);?>"><img src="<?php echo esc_url($_dark_rzlogo['url']);?>" alt=""></a>
                    </div>
                 <?php endif;?> 
