    ...
    <div class="grid-loadmore-content">
        ...
        <?php } wp_reset_query(); ?>
            ...
            <div class="load-more-btn text-center">
                <button aria-label="Load More" id="empath-post-grid-loadmore" class="d-none thm__btn_border d-md-block empath-post-grid-loadmore" data-json_grid_meta="<?php echo esc_attr($ajax_json_data); ?>">
                    <?php echo esc_html__('Load More', 'breeko'); ?>
                </button>
            </div>
            <?php } ?>
