<div class="bytf__post-wrapper rating__post-wrapper">
    <div class="rating__post-row">
    <?php
    if ( $query->have_posts() ) {
    ...
    ?>
        <div class="bytf__post-grid-rating-item">
            ...
            <div class="bytf__content">
                <div class="d-flex align-items-center ratting__mark">
                    ...
                    ?>
                    <?php 
                        if($settings['rating_hide'] === 'yes'){
                            echo do_shortcode('[ratemypost-result id="'.$idd.'"]');?>                            
                            <span> out of 10</span>
                        <?php }                            
                    ?>
                </div>                    
