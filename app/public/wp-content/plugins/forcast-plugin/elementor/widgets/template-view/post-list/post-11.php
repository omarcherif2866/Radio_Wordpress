<div class="bytf__post-list-wrapper">
    ...
    ?>
        <div class="bytf__post-list-item-elv d-flex align-items-center">               
                <div class="bytf__feature-image">
                    <a aria-label="name" href="<?php the_permalink();?>">
                        <?php the_post_thumbnail( 'full' );?>
                    </a> 
                    <div id="bgndVideo" class="player" data-property="{videoURL:'<?php echo esc_url($video_link)?>',containment:'self',autoPlay:true, mute:true, startAt:20, opacity:1, loop:true, stopMovieOnBlur: true, showControls:false, addRaster:true, quality:'default', optimizeDisplay:true}"></div>
                </div>
