<div class="bytf__post-list-wrapper">
    <div class="grid-loadmore-content-two">
        <?php
        if ( $query->have_posts() ) {
        $i = 0;
        ...
        ?>
        <div class="bytf__post-list-item-two style__two d-flex align-items-center">               
        ...
        <?php } wp_reset_query(); ?>
            ...
            <div class="load-more-btn text-center">
                <button aria-label="name" id="empath-post-grid-loadmore-two" class="thm__btn d-none d-md-block empath-post-grid-loadmore-two" data-json_grid_meta="<?php echo esc_attr($ajax_json_data); ?>">
