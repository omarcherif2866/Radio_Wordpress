<div class="bytf__post-hero-wrapper">
    <?php
    if ( $query->have_posts() ) {
    ...
    ?>
    <div class="post__hero-item d-flex align-items-center">
        <div class="bytf__content">
            <h4 class="bytf_post_title"><a aria-label="name" href="<?php the_permalink();?>"><?php echo esc_html($title);?></a> <?php if(!empty($settings['quote_authore'])):?> - <span class="quote"><?php echo esc_html($settings['quote_authore']); ?></span><?php endif;?></h4>
            <?php 
