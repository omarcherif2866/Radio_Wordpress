...
class Empath_Post_Hero extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Hero', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'quote_authore', [
				'label' => esc_html__( 'Quote Autore', 'bdoctor-plugin' ),
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-hero/post-1.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Hero() );