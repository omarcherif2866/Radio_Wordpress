...
class Empath_Post_Overlay extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Overlay', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'con_margin',
			[
				'label' => esc_html__( 'Item Margin', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__post-overlay-item:not(:last-child)' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-overlay/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Overlay() );