...
class Empath_Post_Grid extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Grid', 'empath-plugin' );
	}
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-grid/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Grid() );