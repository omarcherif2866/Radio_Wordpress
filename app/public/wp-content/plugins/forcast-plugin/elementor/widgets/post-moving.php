...
class Empath_Post_Moving extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Moving', 'empath-plugin' );
	}
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-moving/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Moving() );