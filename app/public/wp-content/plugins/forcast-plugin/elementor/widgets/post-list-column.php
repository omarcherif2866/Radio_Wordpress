...
class Empath_Post_List_Column extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post List Column', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			'--img-round--',
			[
				'label' => esc_html__( 'Image Round', 'empath-plugin' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
		...
		$this->add_responsive_control(
			'--box-margin--',
			[
				'label' => esc_html__( 'Margin', 'empath-plugin' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__post-list-item-two' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .bytf__post-list-item-for' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bytf__post-list-wrapper-column .bytf__post-list-item-two' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'--cate-settings--',
			[
				'label' => esc_html__( 'Cate Style', 'empath-plugin' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .elementor-common-cate' => 'color: {{VALUE}}',
				],
			]
		);
        ...
        $this->add_group_control(
			Group_Control_Typography::get_type(),
			[
				'name' => 'cate__typography',
				'label' => esc_html__( 'Excerpt Font', 'empath-plugin' ),
				'selector' => '{{WRAPPER}} .elementor-common-cate',
			]
		);
		$this->add_responsive_control(
			'-cate-excerpt-margin--',
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .elementor-common-cate' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-list-clm/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_List_Column() );