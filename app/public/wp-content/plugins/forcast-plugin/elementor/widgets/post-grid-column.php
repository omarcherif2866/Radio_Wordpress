...
class Empath_Post_Grid_Column extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Grid Column', 'empath-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'print_header_layout',
			[
				'label' => esc_html__( 'Post Layout', 'empath-plugin' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'7'  => esc_html__( 'Style 7', 'empath-plugin' ),
					'8'  => esc_html__( 'Style 8', 'empath-plugin' ),
					'9'  => esc_html__( 'Style 9', 'empath-plugin' )
				]
			]
		);
		$this->add_control(
			'column',
			[
				'label' => esc_html__( 'Post Grid Column Style', 'empath-plugin' ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'column_4',
				'options' => [
					'column_1'  => esc_html__( 'Column 1', 'empath-plugin' ),
					'column_2'  => esc_html__( 'Column 2', 'empath-plugin' ),
					'column_3'  => esc_html__( 'Column 3', 'empath-plugin' ),
					'column_4'  => esc_html__( 'Column 4', 'empath-plugin' ),
					'column_5'  => esc_html__( 'Column 5', 'empath-plugin' ),
				]
			]
		);
		...
		$this->add_control(
			'count_hide',
			[
				'label'          => esc_html__( 'Count Hide', 'empath-plugin' ),
				'type'           => Controls_Manager::SWITCHER,
				'label_on'       => esc_html__( 'Show', 'empath-plugin' ),
				'label_off'      => esc_html__( 'Hide', 'empath-plugin' ),
				'return_value'   => 'yes',
		...
		$this->add_control(
			'content-box--color',
			[
				'label' => esc_html__( 'Content Box Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bytf__post-grid-clm-item .bytf__content' => 'background-color: {{VALUE}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__post-grid-clm-item .bytf__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .with-border .col-lg-3.col-xl-3.col-md-6' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .bytf__post-grid-clm-item' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		$this->add_responsive_control(
			'con_round',
			[
				'label' => esc_html__( 'Round', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
					'{{WRAPPER}} .bytf__content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		$this->end_controls_section();
        ...
        $this->add_control(
			'meta--color',
			[
				'label' => esc_html__( 'Metia Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
			'meta-bk-color',
			[
				'label' => esc_html__( 'Bookmark Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bytf__bookmark.bookmark__dark span' => 'color: {{VALUE}}'
				],
			]
		);
        $this->add_control(
			'meta-bkh-color',
			[
				'label' => esc_html__( 'Bookmark Hover Color', 'empath-plugin' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bytf__bookmark.bookmark__dark span:hover' => 'color: {{VALUE}}'
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Excerpt Font', 'empath-plugin' ),
				'selector' => '
				{{WRAPPER}} .bytf__postmeta.meta__dark ul li,
				{{WRAPPER}} .bytf__postmeta.meta__dark ul li a
				',
			]
		);
		$this->add_responsive_control(
			'--meta-margin--',
			[
				'label' => esc_html__( 'Meta margin', 'textdomain' ),
				'type' => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'selectors' => [
	...
	protected function render() {
		...
		$column_class = '';
		if($settings['column'] === 'column_1'){
			$column_class = 'col-lg-12 col-xl-12';
		}elseif($settings['column'] === 'column_2'){
			$column_class = 'col-lg-6 col-md-6 col-xl-6';
		}elseif($settings['column'] === 'column_3'){
			$column_class = 'col-lg-4 col-xl-4 col-md-6';
		}elseif($settings['column'] === 'column_4'){
			$column_class = 'col-lg-6 col-xl-3 col-md-6';
		}elseif($settings['column'] === 'column_5'){
			$column_class = 'col-byt-5 col-xl-4 col-md-6';
		}else{
			$column_class = 'col-lg-3 col-xl-3 col-md-6';
		}
		

		require __DIR__ . '/template-view/post-grid-column/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_Grid_Column() );