...
class Empath_Post_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post List', 'empath-plugin' );
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'10'  => esc_html__( 'Style 10', 'empath-plugin' ),
					'11'  => esc_html__( 'Style 11', 'empath-plugin' ),
					'12'  => esc_html__( 'Style 12', 'empath-plugin' ),
					'13'  => esc_html__( 'Style 13', 'empath-plugin' ),
					'14'  => esc_html__( 'Style 14', 'empath-plugin' ),
					'15'  => esc_html__( 'Style 15', 'empath-plugin' )
				]
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bytf__post-list-item-two' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .bytf__post-list-item-two.style__thetn .bytf__content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		$this->end_controls_section();
	...
	protected function render() {
		...
		require __DIR__ . '/template-view/post-list/post-' . $settings['style'] . '.php';
    }
...
Plugin::instance()->widgets_manager->register( new Empath_Post_List() );