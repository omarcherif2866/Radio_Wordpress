...
class Templates {
    ...
    public function init()
    {
        ...
        add_action( 'elementor/editor/after_enqueue_scripts', function() {     
            ...
            $localize_data = [
                ...
                'i18n' => [
                    'templatesEmptyTitle'       => esc_html__( 'No Templates Found', 'byteflows-core' ),
                    'templatesEmptyMessage'     => esc_html__( 'Try different category or sync for new templates.', 'byteflows-core' ),
                    'templatesNoResultsTitle'   => esc_html__( 'No Results Found', 'byteflows-core' ),
                    'templatesNoResultsMessage' => esc_html__( 'Please make sure your search is spelled correctly or try a different words.', 'byteflows-core' ),
                ],
    ...
    public static function get_tabs() {
        return apply_filters('byteflows_editor/templates_tabs', [
